...
The [IOOS SOS SWE Element Definitions Vocabulary](http://mmisw.org/ont/ioos/swe_element_type) is a narrower MMI vocabulary of definitions that reflect specific IOOS conventions for use in standard SOS SWE elements. References available on its [MMI vocabulary page](http://mmisw.org/ont/ioos/swe_element_type) give examples of where to use these terms in IOOS SWE SOS templates.
### Keywords 
...
(2) Graybeal, J., A. W. Isenor, and C. Rueda. 2012. Semantic mediation of vocabularies for ocean observing systems. Computers & Geosciences 40: 120-131, [http://dx.doi.org/10.1016/j.cageo.2011.08.002](http://dx.doi.org/10.1016/j.cageo.2011.08.002). Final paper available [here](https://marinemetadata.org/news/mmisemanticpaper2011).
