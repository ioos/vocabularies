...
1. _Vocabularies registered on MMI_
  ...
  * [IOOS vocabulary for definition of SOS SWE element types](http://mmisw.org/ont/ioos/swe_element_type)
  * [Metadata Conventions for IOOS Passive Acoustic Recordings (v1.0)](http://mmisw.org/ont/ioos/passive_acoustic_metadata)
  * [A metadata convention for animal acoustic telemetry data](http://mmisw.org/ont/ioos/animal_acoustic_telemetry)
  * [IOOS Biological Terms](http://mmisw.org/ont/ioos/biological)
  * [A metadata convention for processed acoustic data from active acoustic systems (v1.0)](http://mmisw.org/ont/ioos/active_acoustic_metadata)
  * [IOOS Vocabulary and Category Definitions](http://mmisw.org/ont/ioos/definition)
  * [IOOS Platform Vocabulary](http://mmisw.org/ont/ioos/platform)
  ...
  * [Harmonic Constituent Definitions](http://mmisw.org/ont/ioos/harmonicConstituents)
  * [IOOS Parameter Vocabulary v2.0](http://mmisw.org/ont/ioos/parameter)
  * [Datum Definitions](http://mmisw.org/ont/ioos/datum)
  * [Water Level Definitions](http://mmisw.org/ont/ioos/waterLevel)
  * [Ocean Acidification Definitions](http://mmisw.org/ont/ioos/OA)
  * [CO-OPS QC Flag Definitions](http://mmisw.org/ont/ioos/CO-OPSqcFlags)
  ...
  * [IOOS Vocabulary v1.0](http://mmisw.org/ont/ioos/identifier_parameter_program)
